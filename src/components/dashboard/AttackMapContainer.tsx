...
const AttackMapContainer: React.FC = () => {
  ...
  return (
    <div className="bg-gray-800 rounded-lg overflow-hidden attack-map-container">
      ...
      <div className="flex">
        ...
        {/* Mapa principal */}
        <div className={`flex-grow relative ${isLoading ? 'opacity-70' : ''}`}>
          <WorldMap attackLines={filteredLines} />
          
          {/* Indicador de carga */}
          {isLoading && (
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black bg-opacity-50 rounded-lg p-3 z-[1010]">
